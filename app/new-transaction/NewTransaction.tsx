...
export const NewTransaction = ({ initialId }: NewTransactionProps) => {
  ...
  useEffect(() => {
    ...
    const fetchTransaction = async () => {
      try {
        const response = await fetch(`/api/transactions/${initialId}`)
  ...
  }, [amount, transactionType, initialId, isEdit, router, globalMutate])
